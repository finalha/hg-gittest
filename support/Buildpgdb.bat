...
echo Try login PostGres with password:%pgpwd% username:%pguser%  >>&3
...
echo try connect to postgres >>&3
...
echo Succeed connect to postgres >>&3
...
del sqltmp.txt
echo Succeed create %dbname% DB >>&3
