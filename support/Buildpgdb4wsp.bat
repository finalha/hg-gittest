...
call :GetDBVersion "dbver"
if %dbver% LSS 512 (
"%pgsqlfile%" -h "%pghost%" -p %pgport% -U "%pguser%" -v nbwsp=%dbname%< nbwsp512.sql
echo nbwsp512.sql >&2
)

call :GetDBVersion "dbver"
if %dbver% LSS 513 (
"%pgsqlfile%" -h "%pghost%" -p %pgport% -U "%pguser%" -v nbwsp=%dbname%< nbwsp513.sql
echo nbwsp513.sql >&2
)
...
call :GetDBVersion "dbver"
if %dbver% LSS 514 (
"%pgsqlfile%" -h "%pghost%" -p %pgport% -U "%pguser%" -v nbwsp=%dbname%< nbwsp514.sql
echo nbwsp514.sql >&2
)
